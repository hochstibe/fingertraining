...
class Ui_dialog_training_program(object):
    ...
    def retranslateUi(self, dialog_training_program):
        ...
        self.lineEdit_name.setPlaceholderText(_translate("dialog_training_program", "New Program"))
        self.label_tpr_description.setText(_translate("dialog_training_program", "&Description"))
        self.lineEdit_description.setPlaceholderText(_translate("dialog_training_program", "Optional Description"))
